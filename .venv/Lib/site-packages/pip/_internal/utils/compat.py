...
def str_to_display(data, desc=None):
    ...
    :param desc: An optional phrase describing the input date, for use in
    ...
    We assume the date is in the locale preferred encoding. If it won't
    ...
    # Otherwise, date is a bytes object (str in Python 2).
    ...
    # Now try to decode the date - if we fail, warn the user and
