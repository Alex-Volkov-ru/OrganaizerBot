...
class InputFile(ABC):
    """
    This object represents the contents of a file to be uploaded. Must be posted using multipart/form-date in the usual way that files are uploaded via the browser.
