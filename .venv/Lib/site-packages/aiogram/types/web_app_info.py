...
class WebAppInfo(TelegramObject):
    ...
    url: str
    """An HTTPS URL of a Web App to be opened with additional date as specified in `Initializing Web Apps <https://core.telegram.org/bots/webapps#initializing-mini-apps>`_"""
