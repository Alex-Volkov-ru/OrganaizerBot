...
class InputInvoiceMessageContent(InputMessageContent):
    ...
    """*Optional*. A JSON-serialized object for date about the invoice, which will be shared with the payment provider. A detailed description of the required fields should be provided by the payment provider."""
