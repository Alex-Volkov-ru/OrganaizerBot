...
class LoginUrl(TelegramObject):
    ...
    url: str
    """An HTTPS URL to be opened with user authorization date added to the query string when the button is pressed. If the user refuses to provide authorization date, the original URL without information about the user will be opened. The date added is the same as described in `Receiving authorization date <https://core.telegram.org/widgets/login#receiving-authorization-data>`_."""
