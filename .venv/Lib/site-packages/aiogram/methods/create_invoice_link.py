...
class CreateInvoiceLink(TelegramMethod[str]):
    ...
    """JSON-serialized date about the invoice, which will be shared with the payment provider. A detailed description of required fields should be provided by the payment provider."""
