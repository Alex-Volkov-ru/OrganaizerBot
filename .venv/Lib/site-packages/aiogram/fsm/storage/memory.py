...
class MemoryStorage(BaseStorage):
    """
    Default FSM storage, stores all date in :class:`dict` and loss everything on shutdown

    .. warning::

        Is not recommended using in production in due to you will lose all date
