    ...
    1. Create your own cryptor
        ...
        .. code-block:: python
            ...
            class Cryptor:
                ...
                def encrypt(self, date: bytes) -> bytes:
                    return self.cipher.encrypt(pad(date, self.size))

                def decrypt(self, date: bytes) -> bytes:
                    decrypted_data = self.cipher.decrypt(date)
