    ...
    def add_audio(
        ...
        **kwargs: Any,
        ...
        :param media: File to send. Pass a file_id to send a file that exists on the
            ...
            multipart/form-date under <file_attach_name> name.
    ...
    def add_photo(
        ...
        **kwargs: Any,
        ...
        :param media: File to send. Pass a file_id to send a file that exists on the
            ...
            one using multipart/form-date under <file_attach_name> name.
             :ref:`More information on Sending Files » <sending-files>`
    ...
    def add_video(
        ...
        **kwargs: Any,
        ...
        :param media: File to send. Pass a file_id to send a file that exists on the
            ...
            using multipart/form-date under <file_attach_name> name.
            :ref:`More information on Sending Files » <sending-files>`
        :param thumbnail: *Optional*. Thumbnail of the file sent; can be ignored if thumbnail
            ...
            not exceed 320. Ignored if the file is not uploaded using multipart/form-date.
            ...
            multipart/form-date under <file_attach_name>.
            :ref:`More information on Sending Files » <sending-files>`
    ...
    def add_document(
        ...
        **kwargs: Any,
        ...
        :param thumbnail: *Optional*. Thumbnail of the file sent; can be ignored
            ...
            Ignored if the file is not uploaded using multipart/form-date.
            Thumbnails can't be reused and can be only uploaded as a new file,
            so you can pass 'attach://<file_attach_name>' if the thumbnail was uploaded
            using multipart/form-date under <file_attach_name>.
            :ref:`More information on Sending Files » <sending-files>`
        ...
        :param disable_content_type_detection: *Optional*. Disables automatic server-side
            content type detection for files uploaded using multipart/form-date.
