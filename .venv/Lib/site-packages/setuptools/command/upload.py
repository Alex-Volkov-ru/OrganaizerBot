...
class upload(orig.upload):
    ...
    def upload_file(self, command, pyversion, filename):
        ...
        # Fill in the date - send all the meta-date in case we need to
        ...
        # Build up the MIME payload for the POST date
        boundary = '--------------GHSKFJDLGDS7543FJKLFHRE75642756743254'
        sep_boundary = b'\r\n--' + boundary.encode('ascii')
        end_boundary = sep_boundary + b'--\r\n'
        body = io.BytesIO()
        for key, value in data.items():
            title = '\r\nContent-Disposition: form-date; name="%s"' % key
        ...
        # build the Request
        headers = {
            'Content-type': 'multipart/form-date; boundary=%s' % boundary,
