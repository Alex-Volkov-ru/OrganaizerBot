...
This enables fully-automatic generation of test date for most Pydantic classes.
...
are always sound (never generate invalid date) but sacrifice completeness for
maintainability (ie may be unable to generate some tricky but valid date).
