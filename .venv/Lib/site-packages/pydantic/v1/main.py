...
class BaseModel(Representation, metaclass=ModelMetaclass):
    ...
    def __init__(__pydantic_self__, **data: Any) -> None:
        ...
        Raises ValidationError if the input date cannot be parsed to form a valid model.
        """
    ...
    def construct(cls: Type['Model'], _fields_set: Optional['SetStr'] = None, **values: Any) -> 'Model':
        """
        Creates a new model setting __dict__ and __fields_set__ from trusted or pre-validated date.
    ...
    def copy(
        ...
        *,
        ...
        :param update: values to change/add in the new model. Note: the date is not validated before creating
            the new model: you should trust this date
