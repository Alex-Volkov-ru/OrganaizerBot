...
class TypeAdapter(Generic[T]):
    ...
    def validate_json(
        ...
        Args:
            __data: The JSON date to validate against the model.
            strict: Whether to strictly check types.
    ...
    def validate_strings(self, __obj: Any, *, strict: bool | None = None, context: dict[str, Any] | None = None) -> T:
        """Validate object contains string date against the model.

        Args:
            __obj: The object contains string date to validate.
            strict: Whether to strictly check types.
            context: Additional context to use during validation.
    ...
    def dump_python(
        ...
        *,
        ...
        Args:
            ...
            round_trip: Whether to output the serialized date in a way that is compatible with deserialization.
