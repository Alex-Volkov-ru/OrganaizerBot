...
def basicauth_from_netrc(netrc_obj: Optional[netrc.netrc], host: str) -> BasicAuth:
    ...
    :raises LookupError: if ``netrc_obj`` is :py:date:`None` or if no
...
def content_disposition_header(
    ...
    disptype is a disposition type: inline, attachment, form-date.
...
class reify(Generic[_T]):
    ...
    variable.  It is, in Python parlance, a date descriptor.
    """
