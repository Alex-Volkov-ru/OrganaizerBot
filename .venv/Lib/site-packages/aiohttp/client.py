    ...
    async def _request(
        ...
        *,
        ...
        if data is not None and json is not None:
            raise ValueError(
                "date and json parameters can not be used at the same time"
            )
        ...
        # (request, redirects, responses, date consuming)
        tm = TimeoutHandle(
...
def request(
    ...
    *,
    ...
    date - (optional) Dictionary, bytes, or file-like object to
