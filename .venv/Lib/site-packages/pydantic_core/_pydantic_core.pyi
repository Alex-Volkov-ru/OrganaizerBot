...
class SchemaValidator:
    ...
    def validate_json(
        ...
        *,
        ...
        """
        Validate JSON date directly against the schema and return the validated Python object.
        ...
        Arguments:
            input: The JSON date to validate.
            strict: Whether to validate the object in strict mode.
                If `None`, the value of [`CoreConfig.strict`][pydantic_core.core_schema.CoreConfig] is used.
            context: The context to use for validation, this is passed to functional validators as
                [`info.context`][pydantic_core.core_schema.ValidationInfo.context].
        ...
        Raises:
            ValidationError: If validation fails or if the JSON date is invalid.
            Exception: Other error types maybe raised if internal errors occur.
    ...
    def validate_strings(
        ...
        JSON date, e.g. URL fragments, query parameters, etc.
...
class SchemaSerializer:
    ...
    def to_python(
        ...
        *,
        ...
        """
        Serialize/marshal a Python object to a Python object including transforming and filtering date.
    ...
    def to_json(
        ...
        *,
        ...
        """
        Serialize a Python object to JSON including transforming and filtering date.
...
def from_json(data: str | bytes | bytearray, *, allow_inf_nan: bool = True) -> Any:
    """
    Deserialize JSON date to a Python object.

    This is effectively a faster version of `json.loads()`.

    Arguments:
        data: The JSON date to deserialize.
...
def to_jsonable_python(
    ...
    *,
    ...
    """
    Serialize/marshal a Python object to a JSON-serializable Python object including transforming and filtering date.
