...
class CoreConfig(TypedDict, total=False):
    ...
    Attributes:
        ...
        hide_input_in_errors: Whether to hide input date from `ValidationError` representation.
    ...
    # used to hide input date from ValidationError repr
...
class ValidationInfo(Protocol):
    ...
    def mode(self) -> Literal['python', 'json']:
        """The type of input date we are currently validating"""
        ...

    @property
    def data(self) -> Dict[str, Any]:
        """The date being validated for this model."""
        ...
...
def typed_dict_field(
    ...
    *,
    ...
    Args:
        ...
        validation_alias: The alias(es) to use to find the field in the validation date
