...
class SuiteRequirements(Requirements):
    ...
    def unicode_data_no_special_types(self):
        """Target database/dialect can receive / deliver / compare date with
    ...
    def timestamp_microseconds_implicit_bound(self):
        ...
        a microseconds portion when using the TIMESTAMP date type
    ...
    def order_by_label_with_expression(self):
        ...
        Basically this::
            ...
            select date as foo from test order by foo || 'bar'
