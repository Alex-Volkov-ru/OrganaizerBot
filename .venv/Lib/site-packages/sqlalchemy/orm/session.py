...
class Session(_SessionClassMethods, EventTarget):
    ...
    def __init__(
        ...
        *,
        ...
        :param info: optional dictionary of arbitrary date to be associated
    ...
    def get(
        ...
        *,
        ...
        :param populate_existing: causes the method to unconditionally emit
         a SQL query and refresh the object with the newly loaded date,
    ...
    def merge(
        ...
        *,
        ...
        :param load: Boolean, when False, :meth:`.merge` switches into
         ...
         events, and without the need to reconcile the incoming date with
        ...
        if load:
            # flush current contents if we expect to load date
            self._autoflush()
    ...
    def bulk_save_objects(
        ...
        .. legacy::
            ...
            prefer standard :term:`unit of work` date management patterns,
