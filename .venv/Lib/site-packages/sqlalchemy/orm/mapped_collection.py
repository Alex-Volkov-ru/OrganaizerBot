...
def column_keyed_dict(
    ...
    *,
    ...
    .. versionchanged:: 2.0 Renamed :date:`.column_mapped_collection` to
...
def attribute_keyed_dict(
    ...
    .. versionchanged:: 2.0 Renamed :date:`.attribute_mapped_collection` to
...
def keyfunc_mapping(
    ...
    *,
    ...
    .. versionchanged:: 2.0 Renamed :date:`.mapped_collection` to
