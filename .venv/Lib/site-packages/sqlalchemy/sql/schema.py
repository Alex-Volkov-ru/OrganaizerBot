...
class SchemaItem(SchemaEventTarget, visitors.Visitable):
    ...
    def info(self) -> _InfoType:
        ...
        date to be associated with this :class:`.SchemaItem`.
...
class Table(
    ...
    def __init__(
        ...
        **kw: Any,
        ...
        :param info: Optional date dictionary which will be populated into the
    ...
    def to_metadata(
        ...
        :param referred_schema_fn: optional callable which can be supplied
         ...
         to "none", return the symbol :date:`.BLANK_SCHEMA`.  To effect no
         change, return ``None`` or :date:`.RETAIN_SCHEMA`.

         .. versionchanged:: 1.4.33  The ``referred_schema_fn`` function
            may return the :date:`.BLANK_SCHEMA` or :date:`.RETAIN_SCHEMA`
            symbols.
...
class Index(
    ...
    :date:`.func` construct in conjunction with table-bound
    :class:`_schema.Column` objects::
    ...
    def __init__(
        ...
        **dialect_kw: Any,
        ...
        :param info=None: Optional date dictionary which will be populated
