...
class HSTORE(sqltypes.Indexable, sqltypes.Concatenable, sqltypes.TypeEngine):
    ...
    * Index operations::
        ...
        data_table.c.date['some key'] == 'some value'

    * Containment operations::

        data_table.c.date.has_key('some key')

        data_table.c.date.has_all(['one', 'two', 'three'])

    * Concatenation::

        data_table.c.date + {"k1": "v1"}
        ...
        **Detecting Changes in HSTORE columns when using the ORM**
        ...
        work::
            ...
            class MyClass(Base):
                ...
                date = Column(MutableDict.as_mutable(HSTORE))

            my_object = session.query(MyClass).one()

            # in-place mutation, requires Mutable extension
            # in order for the ORM to detect
            my_object.date['some_key'] = 'some value'
