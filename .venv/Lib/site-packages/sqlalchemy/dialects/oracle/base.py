...
In Oracle, the date dictionary represents all case insensitive identifier
...
against date dictionary date received from Oracle, so unless identifier names
...
* ``COMPRESS``::
    ...
    Table('mytable', metadata, Column('date', String(32)),
...
instead of a B-tree index::
    ...
    Index('my_index', my_table.c.date, oracle_bitmap=True)
...
compression::
    ...
    Index('my_index', my_table.c.date, oracle_compress=True)
...
class OracleDialect(default.DefaultDialect):
    ...
    def _column_query(self, owner):
        ...
        # all_tab_cols returns date for tables/views/mat-views.
